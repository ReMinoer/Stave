...
namespace Stave
{
        ...
        where TComponent : class, TBase
    {
        ...
        public IWrappedObservableList<TComponent> Components { get; }
        ...
        IWrappedObservableCollection<TComponent> IComposite<TBase, TContainer, TComponent>.Components => Components;
